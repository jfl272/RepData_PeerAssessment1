...
```{r Loading and preprocessing the data, message=FALSE, warning=FALSE, results='asis'}
...
```{r Imputing missing values - Sum of the total numer of steps per day}
...
- There are `r length_NA` missing values in the dataset.
...
```{r Comparison Activity pattern Weekend vs. Weekdays}
